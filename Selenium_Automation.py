...
input.send_keys('Enter you rphone number here')
...
while True:
    ...
    search_button.click()
    time.sleep(3)
    #data = driver.find_element_by_xpath("/html/body/app-root/ion-app/ion-router-outlet/app-appointment-table/ion-content/div/div/ion-grid/ion-row/ion-grid/ion-row/ion-col/ion-grid/ion-row/ion-col[2]/form/ion-grid/ion-row/ion-col[9]/div/div/ul/carousel/div/div")
    for i in range(1,50):
        try:
    ...
    #print(len(hospital_names),len(Vaccine),len(Dates),len(Availability),len(Age))
